        ...
        <div class="my-auto">
            <form id="review-form" action="includes/review-helper.php" method="post">
                ...
                <div class="form-group" style="margin-top: 20px">
                    <label class="title-label" for="review-title" style="font-size: 16px; fornt-wight: bold;">Title</label>
                    <input type="text" name="review-title" id="review-title" style="width: 100%; margin-bottom: 10px;">
                    <textarea name="review" id="review-text" cols="83" rows="3" placeholder="Enter more details..."></textarea>
                ...
                <div class="form-group">
                    <button class="btn btn-outline-success" type="submit" name="review-submit" id="review-submit" style="width: 100%;">Review</button>
                </div>
