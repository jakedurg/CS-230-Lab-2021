...
<main style="background-color:#33475b; background-size: cover; height: 100vh; ">
    ...
    if(isset($_SESSION['uid'])){
        ...
        $photo = $row['profpic']; //path to photo
    ?>
    <div style="background-color= rgb(54, 160, 86)">
            ...
            <div class="my-auto">
                ...
                <form action="includes/upload-helper.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <img src="<?php echo $photo;?>" alt="Profile Photo" onclick="triggered();" id="prof-display">
